...
- **Create an issue**: `gh issue create --title "..." --body "..."`. Use a here-document or body file for multi-line bodies.
- **Read an issue**: `gh issue view <number> --comments`, including its labels and discussion.
...
Do not create, modify, close, label, or assign a GitHub issue unless the active task authorizes that external write.
