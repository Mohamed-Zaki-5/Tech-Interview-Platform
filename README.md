...
The repository currently contains the Phase 1 backend and database foundation for a Technical Interview Platform. The backend is a JavaScript ESM modular monolith built with Node.js, Express, PostgreSQL, and Prisma.
